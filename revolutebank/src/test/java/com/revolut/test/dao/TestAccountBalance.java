...
public class TestAccountBalance {
	...
	@Test
	public void testAccountSingleThreadSameCcyTransfer() throws HSQLDBException {
	...
	@Test
	public void testAccountMultiThreadedTransfer() throws InterruptedException, HSQLDBException {
		final AccountDAO accountDAO = h2DaoFactory.getAccountDAO();
	...
	@Test
	public void testTransferFailOnDBLock() throws HSQLDBException, SQLException {
		...
		try {
			...
			if (fromAccount == null) {
				throw new HSQLDBException("Locking error during test, SQL = " + SQL_LOCK_ACC);
			}
